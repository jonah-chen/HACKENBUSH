...
int main(int argc, char **argv)
{
	...
	glm::vec3 bottomleft(std::stof(argv[7]), std::stof(argv[8]),
						 std::stof(argv[9]));
	glm::vec3 topright(std::stof(argv[10]), std::stof(argv[11]),
					   std::stof(argv[12]));

	std::cout << "A: " << A.x << " " << A.y << " " << A.z << std::endl;
	std::cout << "B: " << B.x << " " << B.y << " " << B.z << std::endl;
	std::cout << "bottomleft: " << bottomleft.x << " " << bottomleft.y << " "
			  << bottomleft.z << std::endl;
	std::cout << "topright: " << topright.x << " " << topright.y << " "
			  << topright.z << std::endl;
